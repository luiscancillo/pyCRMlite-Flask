...
It is implemented to evaluate the use of Flask to support web page interaction.
...
def index():
    ...
    With the app.route decorator, it is called by Flask when the URL root is set in the explorer
...
def identify():
    '''
    identify gets data from the 'identify' request sent by the browser from the index page and
    ...
    # this implementation ignores the password
